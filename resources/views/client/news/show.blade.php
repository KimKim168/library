            ...
            <div class="col-span-7 lg:col-span-8">
                ...
                @endif --}}
                 @if ($item->created_at)
                            <div class="flex nowrap">
                                <p
                                    class="w-[123px] whitespace-nowrap uppercase tracking-wide text-sm text-gray-500 dark:text-gray-300 font-semibold border-r border-gray-600 dark:border-gray-300 pr-5 mr-5 flex-shrink-0">
                                    {{ __('messages.postDate') }}
                                </p>
                                <p class="text-sm text-gray-600 dark:text-gray-200">
