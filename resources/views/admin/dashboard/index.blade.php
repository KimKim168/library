        ...
        <div class="p-4">
            ...
            <div class="grid items-start grid-cols-3 gap-4 sm:grid-cols-3 lg:grid-cols-{{ (count($menu_databases) <= 5) ? count($menu_databases) : '6' }}">
                {{-- @forelse ($menu_databases as $database)
                    ...
                    class="{{ request()->is('admin/settings/slides*') ? 'bg-slate-200 dark:bg-slate-500' : '' }} flex flex-col items-center justify-center p-4 text-center rounded-lg hover:bg-gray-100 dark:hover:bg-gray-600 group">
                    <img src="{{ asset('assets/icons/slide.png') }}" alt="icon"
                        class="object-contain h-20 aspect-square p-0.5 bg-white dark:bg-gray-200 rounded">
                    <div class="text-lg font-bold text-gray-600 dark:text-white">Slides</div>
                    {{-- End slide --}}

                     {{-- Page --}}
                    <a href="{{ url('admin/settings/pages') }}"
                    class="{{ request()->is('admin/settings/pages*') ? 'bg-slate-200 dark:bg-slate-500' : '' }} flex flex-col items-center justify-center p-4 text-center rounded-lg hover:bg-gray-100 dark:hover:bg-gray-600 group">
                    <img src="{{ asset('assets/icons/page.png') }}" alt="icon"
                        class="object-contain h-20 aspect-square p-0.5 bg-white dark:bg-gray-200 rounded">
                    <div class="text-lg font-bold text-gray-600 dark:text-white">Pages</div>
                     {{-- End Page --}}

                     {{-- Links --}}
                    <a href="{{ url('admin/settings/links') }}"
                    class="{{ request()->is('admin/settings/links*') ? 'bg-slate-200 dark:bg-slate-500' : '' }} flex flex-col items-center justify-center p-4 text-center rounded-lg hover:bg-gray-100 dark:hover:bg-gray-600 group">
                    <img src="{{ asset('assets/icons/link.png') }}" alt="icon"
                        class="object-contain h-20 aspect-square p-0.5 bg-white dark:bg-gray-200 rounded">
                    <div class="text-lg font-bold text-gray-600 dark:text-white">Links</div>
                     {{--End Links --}}

                       {{-- features --}}
                    <a href="{{ url('admin/settings/features') }}"
                    class="{{ request()->is('admin/settings/features*') ? 'bg-slate-200 dark:bg-slate-500' : '' }} flex flex-col items-center justify-center p-4 text-center rounded-lg hover:bg-gray-100 dark:hover:bg-gray-600 group">
                    <img src="{{ asset('assets/icons/feature.png') }}" alt="icon"
                        class="object-contain h-20 aspect-square p-0.5 bg-white dark:bg-gray-200 rounded">
                    <div class="text-lg font-bold text-gray-600 dark:text-white">features</div>
                     {{-- End features --}}

                     {{-- libraries --}}
                    <a href="{{ url('admin/settings/libraries') }}"
                    class="{{ request()->is('admin/settings/libraries*') ? 'bg-slate-200 dark:bg-slate-500' : '' }} flex flex-col items-center justify-center p-4 text-center rounded-lg hover:bg-gray-100 dark:hover:bg-gray-600 group">
                    <img src="{{ asset('assets/icons/library.png') }}" alt="icon"
                        class="object-contain h-20 aspect-square p-0.5 bg-white dark:bg-gray-200 rounded">
                    <div class="text-lg font-bold text-gray-600 dark:text-white">libraries</div>
                     {{--End libraries --}}


                     {{-- footer --}}
                    <a href="{{ url('/admin/settings/footer/1/edit') }}"
                    class="{{ request()->is('admin/settings/footer*') ? 'bg-slate-200 dark:bg-slate-500' : '' }} flex flex-col items-center justify-center p-4 text-center rounded-lg hover:bg-gray-100 dark:hover:bg-gray-600 group">
                    <img src="{{ asset('assets/icons/footer.png') }}" alt="icon"
                        class="object-contain h-20 aspect-square p-0.5 bg-white dark:bg-gray-200 rounded">
                    <div class="text-lg font-bold text-gray-600 dark:text-white">footer</div>
                     {{--End footer --}}

                     {{-- website_infos --}}
                    <a href="{{ url('/admin/settings/website_infos/1/edit') }}"
                    class="{{ request()->is('admin/settings/website_infos*') ? 'bg-slate-200 dark:bg-slate-500' : '' }} flex flex-col items-center justify-center p-4 text-center rounded-lg hover:bg-gray-100 dark:hover:bg-gray-600 group">
                    <img src="{{ asset('assets/icons/webInfo.png') }}" alt="icon"
                        class="object-contain h-20 aspect-square p-0.5 bg-white dark:bg-gray-200 rounded">
                    <div class="text-lg font-bold text-gray-600 dark:text-white">website infos</div>
                     {{--End website_infos --}}
                </div>
