                                    ...
                                    <li x-data="{
                                        ...
                                        <div type="button"
                                            ...
                                            <img src="{{ asset('assets/images/databases/' . $database->image) }}"
                                                ...
                                                class="object-contain w-8 h-8 p-0.5 bg-white dark:bg-gray-200 rounded">
                                            <span
                                                class="flex-1 text-left ms-3 rtl:text-right whitespace-nowrap"> <a href="{{ route('admin.videos.index') }}"
                                                >Videos</a></span>
                                ...
                                <ul x-show="open" x-transition class="py-2 ml-2 space-y-2" x-ref="dropdown">
                                    ...
                                    <li>
                                        <a href="{{ url('admin/settings/pages') }}"
                                            class="flex items-center w-full p-2 text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700 {{ request()->is('admin/settings/pages*') ? 'bg-slate-200 dark:bg-slate-500' : '' }}">
                                            Pages
                                        </a>
                                    </li>
                                    <li>
                                    ...
                                    <li>
                                        <a href="{{ url('admin/settings/libraries') }}"
                                            class="flex items-center w-full p-2 text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700 {{ request()->is('admin/settings/libraries*') ? 'bg-slate-200 dark:bg-slate-500' : '' }}">
                                            Libraries
                                        </a>
                                    </li>
                                    <li>
