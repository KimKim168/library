                ...
                <button type="button" @click="show = false"
                    ...
                    <svg class="w-3 h-3" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none"
                        ...
                        <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                            d="m1 1 6 6m0 0 6 6M7 7l6-6M7 7l-6 6" />Upload Banner
                    </svg>
                </button>
            </div>
        </div>
       ...
       {{-- <div class="grid grid-cols-2 gap-5 mb-5 lg:grid-cols-3">
        ...
        <div class="mb-5">
            ...
            <div class="items-center gap-5 mb-5 lg:flex space-4" wire:key='uploadbanner'>
                <div class="flex flex-col flex-1">
                    <label class='mb-4 text-sm font-medium text-gray-600 dark:text-white'>
                        Upload Banner (Max: 2MB) (Recommend : 16x3 or 1600x300 pixels) <span class="text-red-500">*</span>
                    </label>
                    <div class="relative flex items-center justify-center w-full -mt-3 overflow-hidden">
                        <label for="dropzone-file"
                            class="flex flex-col items-center justify-center w-full h-40 border-2 border-gray-300 border-dashed rounded-lg cursor-pointer bg-gray-50 dark:hover:bg-bray-800 dark:bg-gray-700 hover:bg-gray-100 dark:border-gray-600 dark:hover:border-gray-500 dark:hover:bg-gray-600">
                ...
                <div class="flex flex-col flex-1">
                    ...
                    <div class="relative flex items-center justify-center w-full -mt-3 overflow-hidden">
                        <label for="dropzone-file"
                            ...
                            <input wire:model="banner_academy" accept="image/png, image/jpeg, image/gif" id="dropzone-file"
                                type="file" class="absolute h-[140%] w-[100%]" />
                        </label>
                    </div>
                    <div wire:loading wire:target="banner_academy" class="text-blue-700">
                        <span>
                            <img class="inline w-6 h-6 text-white me-2 animate-spin" src="{{ asset('assets/images/reload.png') }}" alt="reload-icon">
                            Uploading...
                        </span>
                    </div>
                    <x-input-error :messages="$errors->get('banner_academy')" class="mt-2" />
                </div>
                @if ($banner_academy)
                <div class="flex-1 pt-5">
                    <img src="{{ $banner_academy->temporaryUrl() }}" alt="Banner Image" class="object-contain max-w-full max-h-40" />
                </div>
            @elseif($item->banner_academy)
                <div class="flex-1 pt-5">
                    <img src="{{ asset('assets/images/website_infos/'.$item->banner_academy) }}" alt="Banner Image" class="object-contain w-full max-h-40" />
                </div>
            @endif
            </div>
            {{-- End Image Upload --}}
                ...
                <div class="flex flex-col flex-1">
                    ...
                    <div class="relative flex items-center justify-center w-full -mt-3 overflow-hidden">
                        <label for="dropzone-file"
                            ...
                            <input wire:model="banner_support" accept="image/png, image/jpeg, image/gif" id="dropzone-file"
                                type="file" class="absolute h-[140%] w-[100%]" />
                        </label>
                    </div>
                    <div wire:loading wire:target="banner_support" class="text-blue-700">
                        <span>
                            <img class="inline w-6 h-6 text-white me-2 animate-spin" src="{{ asset('assets/images/reload.png') }}" alt="reload-icon">
                            Uploading...
                        </span>
                    </div>
                    <x-input-error :messages="$errors->get('banner_support')" class="mt-2" />
                </div>
                @if ($banner_support)
                <div class="flex-1 pt-5">
                    <img src="{{ $banner_support->temporaryUrl() }}" alt="Banner Image" class="object-contain max-w-full max-h-40" />
                </div>
            @elseif($item->banner_support)
                <div class="flex-1 pt-5">
                    <img src="{{ asset('assets/images/website_infos/'.$item->banner_support) }}" alt="Banner Image" class="object-contain w-full max-h-40" />
                </div>
            @endif
            </div>
            {{-- End Image Upload --}}
